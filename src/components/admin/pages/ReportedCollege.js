...
import TableReported from '../Global/TableReported';
const drawerWidth ="280px"
const dummyData = []

const ReportedCollege = () => {
  ...
  return (
   ...
   <Grid container>
          ...
          <Grid item container justifyContent="space-between" alignItems="center" mt="15px">
           <Grid item>
              <Button id="addnewuser_btnText" startIcon={<ArrowCircleRightOutlinedIcon/>} sx={{fontWeight:500,fontSize:"20px",color:"#212529",textTransform:"unset"}}>Reported Colleges</Button>
             <Button id="addnewuser_btnText2" sx={{fontWeight:500,fontSize:"20px",color:"#212529",textTransform:"unset"}}>Reported Colleges</Button>
           </Grid>
          </Grid>
          ...
          <Grid item container component={Paper} mt="20px">
            <Grid item lg={12} md={12} sm={12} xs={12}>
              <Box sx={{width:"100%",bgcolor:"#282a3c",color:"white",height:"40px",display:"flex",alignItems:"center"}}>
                <Typography ml="10px" fontSize="18px">Reported Listings</Typography>
              </Box>
            </Grid>
    ...
    <Grid item xs={12} lg={12} md={12} sm={12}>
          <TableReported dummyData={dummyData} rows={rows} setRows={setRows}/>
    </Grid>
      </Grid>
    </Paper>
              </Grid>
...
export default ReportedCollege